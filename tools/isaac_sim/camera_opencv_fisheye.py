#!/usr/bin/env python3
"""OpenCV fisheye camera example based on the 21차시 교안코드."""
...
camera.set_opencv_fisheye_properties(
    ...
    fx=fx,
    fy=fy,
    fisheye=distortion_coefficients,
)
...
image_path = output_dir / "camera_opencv_fisheye.png"
usd_path = output_dir / "camera_opencv_fisheye.usd"
